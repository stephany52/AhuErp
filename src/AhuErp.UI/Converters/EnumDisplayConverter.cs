...
namespace AhuErp.UI.Converters
{
    ...
    public sealed class EnumDisplayConverter : IValueConverter
    {
        private static readonly IReadOnlyDictionary<Enum, string> Map = new Dictionary<Enum, string>
        {
            ...
            // Bug #7. Подписи фасеточных фильтров и пресетов РКК.
            [DocumentTypeFacet.All] = "Все",
            ...
            [DocumentTypeFacet.ArchiveRequests] = "Архивные запросы",
            [DocumentTypeFacet.VehicleTrips] = "Транспортные путёвки",
            [DocumentTypeFacet.WriteOffs] = "Акты списания",

            [DocumentStatusFacet.All] = "Все",
            [DocumentStatusFacet.Draft] = "Черновик",
            ...
            [DocumentRoleFacet.Executor] = "Я исполнитель",
            [DocumentRoleFacet.Approver] = "Я согласующий",
            [DocumentRoleFacet.Signer] = "Я подписант",

            [DocumentDeadlineFacet.All] = "Все",
            [DocumentDeadlineFacet.Overdue] = "Просрочено",
            [DocumentDeadlineFacet.ThisWeek] = "На этой неделе",
            [DocumentDeadlineFacet.NextWeek] = "На следующей неделе",
            [DocumentDeadlineFacet.NoDeadline] = "Без срока",

            [RkkPreset.All] = "Все документы",
            [RkkPreset.OfficeDocuments] = "Документационное обеспечение",
            [RkkPreset.MyTasks] = "Мои задачи",
            [RkkPreset.Archive] = "Архивный отдел",
            [RkkPreset.ItService] = "ИТО",
            [RkkPreset.Journals] = "Журналы регистрации",
            [RkkPreset.Search] = "Поиск",
